...
xcrun swiftc -swift-version 5 \
  ...
  macos/DirectFeeds.swift macos/SourceTimes.swift macos/Products.swift macos/NewsStore.swift \
  macos/DirectFeedTests.swift macos/SourceTimeTests.swift macos/ProductTests.swift macos/Tests.swift \
