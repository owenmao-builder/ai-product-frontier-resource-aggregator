...
xcrun swiftc -swift-version 5 \
  macos/Models.swift macos/ArticleEvidence.swift macos/Scoring.swift macos/NewsPriority.swift \
  macos/DirectFeeds.swift macos/LocalCollector.swift macos/SourceTimes.swift macos/Products.swift macos/NewsStore.swift \
  macos/DirectFeedTests.swift macos/SourceTimeTests.swift macos/ProductTests.swift macos/PriorityTests.swift macos/Tests.swift \
