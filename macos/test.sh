...
xcrun swiftc -swift-version 5 \
  macos/Models.swift macos/ArticleEvidence.swift macos/Scoring.swift macos/InterestScore.swift macos/TechnicalSignals.swift macos/NewsPriority.swift macos/NewsEvents.swift \
