...
- Trending includes a product's active news event with at least two distinct reporting sources within 48 hours, GitHub's weekly Trending list with at least 500 new stars, or a matching HN story from the last 7 days with at least 100 points. The board opens with all products and prioritizes concentrated reporting, including independent models; event subjects prevent borrowing a competitor's attention. Evidence older than 24 hours no longer qualifies. Popularity is not a quality score.
